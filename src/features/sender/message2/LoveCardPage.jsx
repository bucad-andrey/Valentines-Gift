...
import { fetchLoveCards, saveLoveCard } from "../../../shared/lib/firestore/firestoreHelpers";
...
export default function LoveCardPage() {
  ...
  const handleMessageChange = (index, text) => {
    setCards((prev) => {
      const next = [...prev];
      next[index] = { ...next[index], message: text };
      return next;
    });
  };
  ...
  return (
    <section className="bg-linear-to-br from-primary-soft to-secondary-soft p-6 min-h-screen">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        {saveStatus === "success" && (
          <p className="text-success font-medium">All cards have been saved.</p>
        )}
